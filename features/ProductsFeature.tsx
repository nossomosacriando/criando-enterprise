      ...
      <div className="container mx-auto px-6">
        ...
        <header className="text-center mb-24 space-y-6">
          ...
          >
            <h1
              id="products-title"
              className="text-5xl md:text-8xl font-black tracking-tighter leading-none text-gray-900"
            >
            ...
            <p className="text-gray-500 text-xl md:text-2xl max-w-2xl mx-auto font-light leading-relaxed mt-6">
              Desenvolvemos aplicativos projetados para potencializar seu tempo
              e organizar suas paixões digitais.
            </p>
          </motion.div>
        </header>
